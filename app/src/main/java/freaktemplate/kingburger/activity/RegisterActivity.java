...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void register(String mobile, String password, String name) {
                ...
                .getAsString(new StringRequestListener() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (success.equals("1")) {
                                JSONObject register = data.optJSONObject("register");
                                String user_id = register.optString("user_id");
                                String name = register.optString("name");
                                String phone = register.optString("phone");
                                String email = register.optString("email");

                                Log.e(TAG, "onResponse: " + email);
...
//                                alreadyRegister(true);
                                String register = data.optString("register");
