...
public class DeliveryBoyOrderDetail extends AppCompatActivity {
    ...
    private void getDataFromServer() {
        ...
        String url = getString( R.string.link ) + "api/order_item_details?order_id=" + orderNo;
    ...
    private void postData(String isPick) {
        ...
        if (isPick.equals( "pick" )) {
            url = getString( R.string.link ) + "api/order_pick?order_id=" + orderNo;
        } else if (isPick.equals( "complete" )) {
            url = getString( R.string.link ) + "api/order_complete?order_id=" + orderNo;
        }
        if (url != null) {
            Log.e( getLocalClassName(), url );
            StringRequest stringRequest = new StringRequest( Request.Method.GET, url, new Response.Listener <String>() {
